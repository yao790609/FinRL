...
train = pd.read_csv("C:\\Users\\User\\Desktop\\Daily Report_2024_SMC\\上市資料整合_訓練集.csv",engine='python', encoding = "cp950",index_col=0)
validation = pd.read_csv("C:\\Users\\User\\Desktop\\Daily Report_2024_SMC\\上市資料整合_驗證集.csv",engine='python', encoding = "cp950",index_col=0)
